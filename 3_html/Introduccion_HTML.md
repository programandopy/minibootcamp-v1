...
Creá una carpeta en tu aplicación llamada `images` y en ella, agregá todas las imágenes de la [carpeta del código fuente](/assets/images/layout/){:target="_blank"}; (hay 20 imágene en total).
